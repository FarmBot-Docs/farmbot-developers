...
**Farmware is not the only way to write custom Farmbot software.** Please see [this document](/v10/Documentation/farmware/you-might-not-need-farmware.md) for more information
...
Also see the [Celery Script developer documentation](/v10/Documentation/celery-script.md) and [the corpus](https://github.com/FarmBot/farmbot-js/blob/master/dist/corpus.d.ts) for more information.
