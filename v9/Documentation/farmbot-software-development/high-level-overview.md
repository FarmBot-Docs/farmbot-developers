...
|                              |                              |
|------------------------------|------------------------------|
|[Firmware](/v9/Documentation/firmware.md)      |C++
|[FarmBot OS](/v9/Documentation/farmbot-os.md)  |Elixir
|[Rest API](/v9/Documentation/web-app/rest-api.md)      |Ruby on Rails
|[Web App](/v9/Documentation/web-app.md)        |ReactJS, Typescript, and WebPack
...
|------------------------------|------------------------------|
|Long-Term Data Storage        |[REST API](/v9/Documentation/web-app/rest-api.md)
|Remotely managing device when device is offline|[Web App](/v9/Documentation/web-app.md) and [REST API](/v9/Documentation/web-app/rest-api.md)
|Managing device and account data.|[Web App](/v9/Documentation/web-app.md) and [REST API](/v9/Documentation/web-app/rest-api.md)
|Powering actuators            |[Firmware](/v9/Documentation/firmware.md)
|User-defined plugins          |[FarmBot OS](/v9/Documentation/farmbot-os.md) ([Farmware](/v9/Documentation/farmware.md))
|Recurring tasks               |[FarmBot OS](/v9/Documentation/farmbot-os.md)
|Long-running operations, such as watering sequences|[FarmBot OS](/v9/Documentation/farmbot-os.md)
