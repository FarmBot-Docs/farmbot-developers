...
updatedAt: "2019-01-18T04:15:14.269Z"
---
 ...
 * To send messages between users and devices over [MQTT](doc:message-broker)
 * To build [3rd party "Farmware"](doc:farmware) (plugins) that talk directly to FarmBot
...
Nodes are typically seen in the [Message Broker](doc:message-broker-1) in the form of RPC requests. They are also used in the `/sequences` endpoint of the [REST API](doc:rest-api) as stored sequences.
