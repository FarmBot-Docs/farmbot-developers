...
FarmBot OS communication via [Farmware](doc:farmware) and the [Message Broker](doc:message-broker) consists of higher-level [CeleryScript](doc:celery-script) commands, not the commands on listed on this page.
