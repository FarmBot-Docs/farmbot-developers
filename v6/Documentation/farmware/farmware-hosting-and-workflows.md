...
__Cons:__
* Must be able to compile FarmBot OS on a compatible system. (see [FarmBot OS](doc:farmbot-os)).

## Process
1. Follow the instructions for setting up a local development environment for [FarmBot OS](doc:farmbot-os).
