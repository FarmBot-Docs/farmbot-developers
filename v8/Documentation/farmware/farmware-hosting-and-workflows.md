...
* __The Farmware code__: a `.py` file that contains or runs the code you've written. (See [Farmware](/v8/Documentation/farmware.md).)
...
Troubleshooting tips can be found on the [Common Farmware Problems](/v8/Documentation/farmware/common-farmware-problems.md) page.
...
|**Cons**                      |Must be able to compile FarmBot OS on a compatible system. (see [FarmBot OS](/v8/Documentation/farmbot-os.md))
