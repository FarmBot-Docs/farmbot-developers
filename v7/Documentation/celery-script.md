...
Javascript developers are encouraged to use [FarmBot JS](/v7/Documentation/farmbot-js.md) instead of raw CeleryScript for most use cases.
 ...
 * To send messages between users and devices over [MQTT](/v7/Documentation/web-app/message-broker.md)
 * To build [3rd party "Farmware"](/v7/Documentation/farmware.md) (plugins) that talk directly to FarmBot
...
Nodes are typically seen in the [Message Broker](doc:message-broker-1) in the form of RPC requests. They are also used in the `/sequences` endpoint of the [REST API](/v7/Documentation/web-app/rest-api.md) as stored sequences.
