...
updatedAt: "2019-07-16T19:30:35.101Z"
---
...
The FarmBot API provides an HTTP based [REST API](doc:rest-api). HTTP follows a response-request format, which is great when you are explicitly looking for data.
